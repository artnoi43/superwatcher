...
import (
	...
	"github.com/artnoi43/superwatcher/examples/demoservice/internal/lib/utils"
)
...
func testHandleENSLogs(t *testing.T, logsJSON, logsName string) {
	...
	bundle := NewTestSuiteENS(datagateway.NewMockDataGatewayENS(), 3)
